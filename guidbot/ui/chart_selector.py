"""
ui/chart_selector.py  ─  병동 대시보드 차트 타입 선택기 v1.1
# [2026-05-08] 옵션 라벨 이모지 전면 제거 — pill 버튼 한 줄 표기 보장
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
CHART_REGISTRY: Dict[str, Dict] = {
    ...
    "dx_7day": {
        ...
        "options": [
            ...
            ("treemap", "트리맵"), # 트리맵: 빈도가 높은 상병 시각적 강조
        ],
        "default": "pie",
    },
    ...
    "dx_compare": {
        "label": "금일 vs 전일 비교",
        "options": [
            ("overlay", "중첩"),   # 기본값: 같은 축에 투명도로 중첩
            ("grouped", "그룹"),   # 그룹 막대: 나란히 비교
            ("bar_h",   "수평"),   # 수평: 상병명 공간 여유
        ],
        "default": "overlay",
    },
}
...
def render_section_header_inline(
    ...
    # pill 컬럼 너비: 이모지 제거로 버튼 폭 감소 — 옵션 수 × 11 기준
    # 최소 36% / 최대 52% — 제목 영역을 더 넓게 확보
    # [2026-05-08] 14 → 11 (이모지 제거 후 한글 2~3자 기준 재보정)
    _n_opts  = len(labels)
    _pill_w  = max(36, min(52, _n_opts * 11))
