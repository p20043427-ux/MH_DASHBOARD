...
REM ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
echo.
echo  [2/5] 포트 충돌 확인 중 (8501, 8502, 8503, 8504, 8505)...
...
REM 8504 포트 사용 중인 프로세스 종료 (관리자 대시보드)
for /f "tokens=5" %%a in ('netstat -aon ^| findstr ":8504 " 2^>nul') do (
    echo  ^^!  포트 8504 사용 중인 PID %%a 종료
...
ping -n 3 127.0.0.1 > nul
echo  ^^!  관리자 대시보드 시작: http://localhost:8504  (이 PC에서만 접근 가능)
...
echo  ⚙️  관리자 대시보드: http://localhost:8504  (이 PC에서만)
echo  🗄️  벡터DB 관리자: http://localhost:8505  (이 PC에서만)
